...
while opcion != 0:
    ...
    if opcion == 1:
        ...
        quiero_magnitud = int(input("Magnitud: ")) if int(input("Magnitud: ")) else None 
        ...
        packpor  = int(raw_input("Packpor: "))
        magnitud  = raw_input("Magnitud: ")        
        datos  = [dato for dato in datos if packpor == dato["packpor"] and magnitud in dato["unidadWeb"]]
